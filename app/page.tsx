...
const WHATSAPP_NUMBER = "39396884650";
const WHATSAPP_URL = `https://wa.me/${WHATSAPP_NUMBER}?text=${encodeURIComponent("Ciao Giuseppe!")}`;
        ...
        <section className="flex flex-col items-center gap-4 text-center">
          ...
          <div className="flex flex-col gap-3">
            ...
            <p className="text-lg leading-relaxed text-zinc-600 dark:text-zinc-400 sm:text-xl">
              Tu mi dici cosa devi acquistare e io lo segno e ti propongo delle
              offerte. <br />
              ❤️‍🔥Ti piace? compri. <br />
              💔Non ti piace? non compri.
            </p>
          </div>
          ...
          <a
            ...
            className="inline-flex h-14 w-full max-w-sm items-center justify-center gap-3 rounded-full bg-[#25D366] px-8 text-base font-semibold text-white shadow-lg transition-all hover:scale-[1.02] hover:bg-[#20bd5a] active:scale-[0.98] sm:text-lg"
          >
            <svg
              viewBox="0 0 24 24"
              fill="currentColor"
